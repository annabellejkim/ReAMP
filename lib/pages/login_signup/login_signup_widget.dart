...
class _LoginSignupWidgetState extends State<LoginSignupWidget> {
  ...
  void initState() {
    ...
    _model.confirmpwTextController ??= TextEditingController();
    _model.confirmpwFocusNode ??= FocusNode();
  }
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          cursorColor: FlutterFlowTheme.of(context).primaryText,
                          enableInteractiveSelection: true,
                          validator: _model.gmailTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Container(
                      ...
                      Container(
                        width: 200.0,
                        child: TextFormField(
                          controller: _model.confirmpwTextController,
                          focusNode: _model.confirmpwFocusNode,
                          autofocus: false,
                          enabled: true,
                          obscureText: !_model.confirmpwVisibility,
                          decoration: InputDecoration(
                            isDense: false,
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                            ...
                            suffixIcon: InkWell(
                              onTap: () async {
                                safeSetState(() => _model.confirmpwVisibility =
                                    !_model.confirmpwVisibility);
                              },
                              focusNode: FocusNode(skipTraversal: true),
                              child: Icon(
                                _model.confirmpwVisibility
                          ...
                          cursorColor: FlutterFlowTheme.of(context).primaryText,
                          enableInteractiveSelection: true,
                          validator: _model.confirmpwTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      if (FFAppState().signupError == true)
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 5.0, 0.0, 5.0),
                          child: Text(
                            'Couldn’t create your account. Please check your information and try again.',
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            FFAppState().signupError = true;
                            safeSetState(() {});
                            GoRouter.of(context).prepareAuthEvent();
                            if (_model.passwordTextController.text !=
                                _model.confirmpwTextController.text) {
                            ...
                            context.pushNamedAuth(
                                CheckInWidget.routeName, context.mounted);
                          },
                          text: 'Sign Up',
