                            ...
                            children: [
                              Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.asset(
                                    'assets/images/ReAMPlogo-removebg-preview.png',
                                    width: 75.0,
                                    height: 75.0,
                                    fit: BoxFit.cover,
                                  ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (FFAppState().loginError == true)
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 15.0),
                                    child: Text(
                                      'Couldn’t find an account. Please check your email and password.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
